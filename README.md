...
This repo deploys as the `swarmauri-com` self-hosted Docker service. DNS is managed through the PyPI `npmctl-namecheap` provider for the `swarmauri.com` zone and is declared in `desired-state/dns.yaml`.
